...
inline uint32_t pcg_rotr_32(uint32_t value, unsigned int rot)
{
    ...
    return value;
#else
//		printf("4. xorShifted: %lu\n", value);
//		printf("5. rot: %lu\n", rot);
//		printf("6. temp: %lu\n", (value >> rot));
//		printf("7.1 rot.neg(): %lu\n", (- rot) );
//		printf("7.2 this._31: %lu\n",  31);
//		printf("7. temp2: %lu\n", ((- rot) & 31));
//		printf("8. temp2: %lu\n", (value << ((- rot) & 31)));
...
{
	//Mark
//		printf("2. xorShifted: %lu\n", ((state >> 18u) ^ state) >> 27u);
//		printf("3. rot: %lu\n", state >> 59u);
		uint32_t rtn = pcg_rotr_32(((state >> 18u) ^ state) >> 27u, state >> 59u);
		return rtn;
}
